...
2. **Matrix Configuration:** Open `prepare_model.py` or your training script. Adjust the spatial coordinate matrix parameters, feature scaling profiles, your targeted input `.csv` log dataset paths, and the output file title to synchronize with your specific grid layout.
